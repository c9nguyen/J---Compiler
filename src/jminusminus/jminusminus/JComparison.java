...
/**
 * The AST node for a lesser-than (<) expression. Implements short-circuiting
 * branching.
 */

class JLesserThanOp extends JComparison {
    ...
    public JLesserThanOp(int line, JExpression lhs, JExpression rhs) {
        super(line, "<", lhs, rhs);
    }
...
class JGTEqualOp extends JComparison {
    ...
    public JGTEqualOp(int line, JExpression lhs, JExpression rhs) {
        super(line, ">=", lhs, rhs);
    }
