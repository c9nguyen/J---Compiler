    ...
    private JStatement statement() {
        ...
        if (see(LCURLY)) {
            ...
            if  (seeLocalVariableDeclaration()) {            
            	...
            	if (have(SEMI)) {
            		initVar = new JVariableDeclaration(line, mods, vdecls); 
            		...
            		return new JTraditionForStatement(line, initVar, condition, after, statement());
            	} else if (have(TERNARY_END)) {
            		initVar = new JVariableDeclaration(line, mods, vdecls); 
            		JExpression collection = expression();
            		mustBe(RPAREN);
            		return new JEnhancedForStatement(line, initVar, collection, statement());
            	} else {
