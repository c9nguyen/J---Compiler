...
class JComOP extends JBinaryExpression {
    ...
    public JComOP(int line, JExpression lhs, JExpression rhs) {
        super(line, "~", lhs, rhs);
    }
...
class JLeftSOP extends JBinaryExpression {
    ...
    public JLeftSOP(int line, JExpression lhs, JExpression rhs) {
        super(line, "<<", lhs, rhs);
    }
...
class JRightSOP extends JBinaryExpression {
    ...
    public JRightSOP(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>", lhs, rhs);
    }
...
class JZeroSOP extends JBinaryExpression {
    ...
    public JZeroSOP(int line, JExpression lhs, JExpression rhs) {
        super(line, ">>>", lhs, rhs);
    }
